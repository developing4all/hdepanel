...
contains(DEFINES, HDE_HAVE_WAYLAND) {
    ...
    system(wayland-scanner client-header $$WAYLAND_PROTOCOL $$OUT_PWD/../build/lib/wlr-layer-shell-unstable-v1-client-protocol.h)
    system(wayland-scanner private-code $$WAYLAND_PROTOCOL $$OUT_PWD/../build/lib/wlr-layer-shell-unstable-v1-protocol.c)
    system(wayland-scanner client-header $$XDG_SHELL_PROTOCOL $$OUT_PWD/../build/lib/xdg-shell-client-protocol.h)
    system(wayland-scanner private-code $$XDG_SHELL_PROTOCOL $$OUT_PWD/../build/lib/xdg-shell-protocol.c)

    SOURCES += ../build/lib/wlr-layer-shell-unstable-v1-protocol.c \
               ../build/lib/xdg-shell-protocol.c
    HEADERS += ../build/lib/wlr-layer-shell-unstable-v1-client-protocol.h \
               ../build/lib/xdg-shell-client-protocol.h
}
